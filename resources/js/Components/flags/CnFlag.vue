<template>
    ...
    >
        ...
        <use height="20" xlink:href="#cn-a" transform="matrix(71.9991 0 0 72 120 120)" width="30" />
        <use
            height="20"
            xlink:href="#cn-a"
        ...
        <use
            ...
            width="30"
        />
        <use height="20" xlink:href="#cn-a" transform="matrix(6.5991 -23.0749 23.0746 6.59919 288 168)" width="30" />
        <use
            height="20"
            xlink:href="#cn-a"
