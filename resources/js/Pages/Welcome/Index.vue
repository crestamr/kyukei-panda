...
<template>
    ...
    />
    <div
        class="bg-primary dark:bg-sidebar text-primary-foreground absolute inset-0 flex items-center justify-center transition-colors duration-1000 select-none"
    >
